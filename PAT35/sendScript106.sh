...
outputdir=/hera/hades/user/${user}/apr35/PAT/106pions # outputdir for files AND logFiles
...
par2=${submissiondir}/anapp106pions             # optional par2 : executable
...
filelist=${currentDir}/pp35_106.list  # file list in local dir! not in submissiondir!!!
######################################################################
