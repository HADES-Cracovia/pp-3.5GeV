...
outputdir=/hera/hades/user/${user}/apr35/PAT/109pions # outputdir for files AND logFiles
...
par2=${submissiondir}/anapp109pions             # optional par2 : executable
...
filelist=${currentDir}/pp35_109.list  # file list in local dir! not in submissiondir!!!
######################################################################
