...
outputdir=/hera/hades/user/${user}/apr35/PAT/126pions # outputdir for files AND logFiles
...
par2=${submissiondir}/anapp126pions             # optional par2 : executable
...
filelist=${currentDir}/pp35_126.list  # file list in local dir! not in submissiondir!!!
######################################################################
