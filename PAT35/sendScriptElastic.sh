...
submissiondir=${submmissionbase}/PAT35
...
#outputdir=/hera/hades/user/${user}/apr35/PAT/FILES/SIM/ELASTIC # outputdir for files AND logFiles
#outputdir=/hera/hades/user/${user}/apr35/PAT/FILES/SIM/TWOPION # outputdir for files AND logFiles
#outputdir=/hera/hades/user/${user}/apr35/PAT/FILES/SIM/THREEPION # outputdir for files AND logFiles
#outputdir=/hera/hades/user/${user}/apr35/PAT/FILES/SIM/PPPI0 # outputdir for files AND logFiles
outputdir=/hera/hades/user/${user}/apr35/PAT/FILES/SIM/NPPIP # outputdir for files AND logFiles
...
par2=${submissiondir}/anappsim             # optional par2 : executable
...
filelist=${currentDir}/pp35_elast_sim.list  # file list in local dir! not in submissiondir!!!
######################################################################
