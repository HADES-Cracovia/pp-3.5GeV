...
outputdir=/hera/hades/user/${user}/apr35/PAT/118pions # outputdir for files AND logFiles
...
par2=${submissiondir}/anapp118pions             # optional par2 : executable
...
filelist=${currentDir}/pp35_118.list  # file list in local dir! not in submissiondir!!!
######################################################################
