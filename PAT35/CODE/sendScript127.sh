...
outputdir=/hera/hades/user/${user}/apr35/PAT/127pions # outputdir for files AND logFiles
...
par2=${submissiondir}/anapp127pions             # optional par2 : executable
...
filelist=${currentDir}/pp35_127.list  # file list in local dir! not in submissiondir!!!
######################################################################
