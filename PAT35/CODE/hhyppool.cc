...
{
   int i1, i2, i3, i4, i5, i6, repetitionNr, combinitaionNr;
   EParticle pid;
      ...
      if (combinitaionNr > 0) // for given particle: if number of combinations > 0
      {
            ...
            for (int k=0; k < combinitaionNr; ++k) // all combinations
            {
               switch (ptrC->partNum[ pid ])
               {
                   ...
                   case 5: i1 = ptrFH->map5[ 50 + refPPool.getNum( pid ) ][ k ][0];
                           i2 = ptrFH->map5[ 50 + refPPool.getNum( pid ) ][ k ][1];
                           i3 = ptrFH->map5[ 50 + refPPool.getNum( pid ) ][ k ][2];
                           i4 = ptrFH->map5[ 50 + refPPool.getNum( pid ) ][ k ][3];
                           i5 = ptrFH->map5[ 50 + refPPool.getNum( pid ) ][ k ][4];
                           mpBeginIter = refPPool.lower_bound( pid );
                           mpIter = mpBeginIter;
                           while (i1--) ++mpIter;
                           for (int j=0; j < repetitionNr; ++j) // number of repetitions of combinations
                   ...
                   case 6: i1 = ptrFH->map6[ 60 + refPPool.getNum( pid ) ][ k ][0];
                           i2 = ptrFH->map6[ 60 + refPPool.getNum( pid ) ][ k ][1];
                           i3 = ptrFH->map6[ 60 + refPPool.getNum( pid ) ][ k ][2];
                           i4 = ptrFH->map6[ 60 + refPPool.getNum( pid ) ][ k ][3];
                           i5 = ptrFH->map6[ 60 + refPPool.getNum( pid ) ][ k ][4];
                           i6 = ptrFH->map6[ 60 + refPPool.getNum( pid ) ][ k ][5];
                           mpBeginIter = refPPool.lower_bound( pid );
                           mpIter = mpBeginIter;
                           while (i1--) ++mpIter;
                           for (int j=0; j < repetitionNr; ++j) // number of repetitions of combinations
