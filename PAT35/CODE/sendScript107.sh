...
outputdir=/hera/hades/user/${user}/apr35/PAT/107pions # outputdir for files AND logFiles
...
par2=${submissiondir}/anapp107pions             # optional par2 : executable
...
filelist=${currentDir}/pp35_107.list  # file list in local dir! not in submissiondir!!!
######################################################################
