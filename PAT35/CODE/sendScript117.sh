...
outputdir=/hera/hades/user/${user}/apr35/PAT/117pions # outputdir for files AND logFiles
...
par2=${submissiondir}/anapp117pions             # optional par2 : executable
...
filelist=${currentDir}/pp35_117.list  # file list in local dir! not in submissiondir!!!
######################################################################
