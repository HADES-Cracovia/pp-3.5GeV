...
outputdir=/hera/hades/user/${user}/apr35/PAT/111pions # outputdir for files AND logFiles
...
par2=${submissiondir}/anapp111pions             # optional par2 : executable
...
filelist=${currentDir}/pp35_111.list  # file list in local dir! not in submissiondir!!!
######################################################################
