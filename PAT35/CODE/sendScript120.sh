...
outputdir=/hera/hades/user/${user}/apr35/PAT/120pions # outputdir for files AND logFiles
...
filelist=${currentDir}/pp35_120.list  # file list in local dir! not in submissiondir!!!
######################################################################
