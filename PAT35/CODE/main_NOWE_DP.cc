...
int main(Int_t argc, Char_t **argv)
{
  ...
  TString output_Dir  ="/lustre/hades/user/przygoda/apr07/pat_hadron/";
...
//  myPids.add("HH", "PPip",eProton,ePiPlus);
  ...
  //HGraphCut tCut3("all","/u/przygoda/PAT/DP125_PID_NEW_CUTS.root");
  HGraphCut tCut3("all","/u/przygoda/PAT/pp_cut_id.root");
