...
outputdir=/hera/hades/user/${user}/apr35/PAT/115pions # outputdir for files AND logFiles
...
par2=${submissiondir}/anapp115pions             # optional par2 : executable
...
filelist=${currentDir}/pp35_115.list  # file list in local dir! not in submissiondir!!!
######################################################################
