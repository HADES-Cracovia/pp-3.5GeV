...
//-----------------------------------------------------------------------------
bool HPool::add(const char* name, EParticle p1, EParticle p2, EParticle p3, EParticle p4, EParticle p5)
{
   if (false == isObject(name))
   {
      objectList.push_back( new HPattern( name, p1, p2, p3, p4, p5, ptrFile ) );
      return true;
   }
   return false;
}
...
//-----------------------------------------------------------------------------
bool HPool::add(const char* name, EParticle p1, EParticle p2, EParticle p3, EParticle p4, EParticle p5, EParticle p6)
{
   if (false == isObject(name))
   {
      objectList.push_back( new HPattern( name, p1, p2, p3, p4, p5, p6, ptrFile ) );
      return true;
   }
   return false;
}
...
//-----------------------------------------------------------------------------
bool HPool::add(const char* name, const char* p1, const char* p2, const char* p3, const char* p4, const char* p5)
{
   return add( name, convertId(p1), convertId(p2), convertId(p3), convertId(p4), convertId(p5) );
}

//-----------------------------------------------------------------------------
bool HPool::add(const char* name, const char* p1, const char* p2, const char* p3, const char* p4, const char* p5, const char* p6)
{
   return add( name, convertId(p1), convertId(p2), convertId(p3), convertId(p4), convertId(p5), convertId(p6) );
}
