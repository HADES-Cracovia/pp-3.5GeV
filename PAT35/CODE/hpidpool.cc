...
//-----------------------------------------------------------------------------
bool HPidPool::add(const char* oldname, const char* name, EParticle p1, EParticle p2, EParticle p3, EParticle p4, EParticle p5)
{
   if ( HPool::add( name, p1, p2, p3, p4, p5 ) )
   {
      hypPid.insert( pair<std::string, std::string>( name, oldname ) );
      return true;
   }
...
//-----------------------------------------------------------------------------
bool HPidPool::add(const char* oldname, const char* name, EParticle p1, EParticle p2, EParticle p3, EParticle p4, EParticle p5, EParticle p6)
{
   if ( HPool::add( name, p1, p2, p3, p4, p5, p6 ) )
   {
      hypPid.insert( pair<std::string, std::string>( name, oldname ) );
      return true;
   }
...
//-----------------------------------------------------------------------------
bool HPidPool::add(const char* oldname, const char* name, const char* p1, const char* p2, const char* p3, const char* p4, const char* p5)
{
   return add( oldname, name, convertId(p1), convertId(p2), convertId(p3), convertId(p4), convertId(p5) );
}

//-----------------------------------------------------------------------------
bool HPidPool::add(const char* oldname, const char* name, const char* p1, const char* p2, const char* p3, const char* p4, const char* p5, const char* p6)
{
   return add( oldname, name, convertId(p1), convertId(p2), convertId(p3), convertId(p4), convertId(p5), convertId(p6) );
}
