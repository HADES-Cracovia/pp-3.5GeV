...
int main(Int_t argc, Char_t **argv)
{
    ...
    //***----------------------------------------------------------
    //TString inputDir  ="/hera/hades/user/ramstein/pp35/106/";
    //TString inputDir  ="/hera/hades/user/ramstein/pp35/107/";
    //TString inputDir  ="/hera/hades/user/ramstein/pp35/108/";
    //TString inputDir  ="/hera/hades/user/ramstein/pp35/109/";
    //TString inputDir  ="/hera/hades/user/ramstein/pp35/110/";
    //TString inputDir  ="/hera/hades/user/ramstein/pp35/111/";
    //TString inputDir  ="/hera/hades/user/ramstein/pp35/112/";
    //TString inputDir  ="/hera/hades/user/ramstein/pp35/113/";
    //TString inputDir  ="/hera/hades/user/ramstein/pp35/114/";
    //TString inputDir  ="/hera/hades/user/ramstein/pp35/115/";
    //TString inputDir  ="/hera/hades/user/ramstein/pp35/116/";
    //TString inputDir  ="/hera/hades/user/ramstein/pp35/117/";
    //TString inputDir  ="/hera/hades/user/ramstein/pp35/118/";
    //TString inputDir  ="/hera/hades/user/ramstein/pp35/119/";
    TString inputDir  ="/lustre/nyx/hades/user/ramstein/pp35/120/";
    //TString inputDir  ="/hera/hades/user/ramstein/pp35/121/";
    //TString inputDir  ="/hera/hades/user/ramstein/pp35/122/";
    //TString inputDir  ="/hera/hades/user/ramstein/pp35/123/";
    //TString inputDir  ="/hera/hades/user/ramstein/pp35/124/";
    //TString inputDir  ="/hera/hades/user/ramstein/pp35/125/";
    //TString inputDir  ="/hera/hades/user/ramstein/pp35/126/";
    //TString inputDir  ="/hera/hades/user/ramstein/pp35/127/";
    // ---------------------- SIM ------------------------------------
    //TString inputDir  ="/hera/hades/user/przygoda/apr35/DST/FILES/ELASTIC/";
    //TString inputDir  ="/hera/hades/user/przygoda/apr35/DST/FILES/TWOPION/";
    //TString inputDir  ="/hera/hades/user/przygoda/apr35/DST/FILES/THREEPION/";
    //TString inputDir  ="/hera/hades/user/przygoda/apr35/DST/FILES/PPPI0/";
    //TString inputDir  ="/hera/hades/user/przygoda/apr35/DST/FILES/NPPIP/";

    TString inputFile = argv[1];

    //***----------------------------------------------------------
    //TString output_Dir  ="/hera/hades/user/przygoda/apr35/PAT/106pions/";
    //TString output_Dir  ="/hera/hades/user/przygoda/apr35/PAT/107pions/";
    //TString output_Dir  ="/hera/hades/user/przygoda/apr35/PAT/108pions/";
    //TString output_Dir  ="/hera/hades/user/przygoda/apr35/PAT/109pions/";
    //TString output_Dir  ="/hera/hades/user/przygoda/apr35/PAT/110pions/";
    //TString output_Dir  ="/hera/hades/user/przygoda/apr35/PAT/111pions/";
    //TString output_Dir  ="/hera/hades/user/przygoda/apr35/PAT/112pions/";
    //TString output_Dir  ="/hera/hades/user/przygoda/apr35/PAT/113pions/";
    //TString output_Dir  ="/hera/hades/user/przygoda/apr35/PAT/114pions/";
    //TString output_Dir  ="/hera/hades/user/przygoda/apr35/PAT/115pions/";
    //TString output_Dir  ="/hera/hades/user/przygoda/apr35/PAT/116pions/";
    //TString output_Dir  ="/hera/hades/user/przygoda/apr35/PAT/117pions/";
    //TString output_Dir  ="/hera/hades/user/przygoda/apr35/PAT/118pions/";
    //TString output_Dir  ="/hera/hades/user/przygoda/apr35/PAT/119pions/";
    TString output_Dir  ="/lustre/nyx/hades/user/przygoda/apr35/PAT/120pions_test/";
    //TString output_Dir  ="/hera/hades/user/przygoda/apr35/PAT/121pions/";
    //TString output_Dir  ="/hera/hades/user/przygoda/apr35/PAT/122pions/";
    //TString output_Dir  ="/hera/hades/user/przygoda/apr35/PAT/123pions/";
    //TString output_Dir  ="/hera/hades/user/przygoda/apr35/PAT/124pions/";
    //TString output_Dir  ="/hera/hades/user/przygoda/apr35/PAT/125pions/";
    //TString output_Dir  ="/hera/hades/user/przygoda/apr35/PAT/126pions/";
    //TString output_Dir  ="/hera/hades/user/przygoda/apr35/PAT/127pions/";
    // ---------------------- SIM ------------------------------------
    //TString output_Dir  ="/hera/hades/user/przygoda/apr35/PAT/FILES/SIM/ELASTIC/";
    //TString output_Dir  ="/hera/hades/user/przygoda/apr35/PAT/FILES/SIM/TWOPION/";
    //TString output_Dir  ="/hera/hades/user/przygoda/apr35/PAT/FILES/SIM/THREEPION/";
    //TString output_Dir  ="/hera/hades/user/przygoda/apr35/PAT/FILES/SIM/PPPI0/";
    //TString output_Dir  ="/hera/hades/user/przygoda/apr35/PAT/FILES/SIM/NPPIP/";
    ...
    myHyps.add("HpHpHpHpHmHm", eHadronPos,eHadronPos,eHadronPos,eHadronPos,eHadronNeg,eHadronNeg);
#endif
    //***************************************************
    ...
    myPids2.add("HpHpHpHpHmHm", "PPPipPipPimPim",eProton,eProton,ePiPlus,ePiPlus,ePiMinus,ePiMinus);
#endif
    //***************************************************
#ifdef LEPTONS
    ...
    myPids_A2.add("HpHpHpHpHmHm", "PPPipPipPimPim_ID",eProton,eProton,ePiPlus,ePiPlus,ePiMinus,ePiMinus);
#endif
    //***************************************************
    ...
    HGraphCut tCut3("all","/lustre/nyx/hades/user/przygoda/PAT35/CODE/pp35_cuts.root"); // mass^2 versus mom
