...
//  TString inputDir  ="/lustre/hades/user/beatam/dst_sim/files/pp_el/";
  ...
  //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/pp_elastic_4x_new/";
  ...
  TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/2pion/";
...
//  myPids.add("HH", "PPip",eProton,ePiPlus);
  ...
  //HGraphCut tCut3("all","/u/przygoda/PAT/PP_CUTS_ULTIMATE.root");
  // dla testow
