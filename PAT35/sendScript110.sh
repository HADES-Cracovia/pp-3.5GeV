...
outputdir=/hera/hades/user/${user}/apr35/PAT/110pions # outputdir for files AND logFiles
...
par2=${submissiondir}/anapp110pions             # optional par2 : executable
...
filelist=${currentDir}/pp35_110.list  # file list in local dir! not in submissiondir!!!
######################################################################
