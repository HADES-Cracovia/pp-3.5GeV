...
outputdir=/hera/hades/user/${user}/apr35/PAT/114pions # outputdir for files AND logFiles
...
par2=${submissiondir}/anapp114pions             # optional par2 : executable
...
filelist=${currentDir}/pp35_114.list  # file list in local dir! not in submissiondir!!!
######################################################################
