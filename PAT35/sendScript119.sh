...
outputdir=/hera/hades/user/${user}/apr35/PAT/119pions # outputdir for files AND logFiles
...
par2=${submissiondir}/anapp119pions             # optional par2 : executable
...
filelist=${currentDir}/pp35_119.list  # file list in local dir! not in submissiondir!!!
######################################################################
