...
#outputdir=/hera/hades/user/${user}/apr35/PAT/123 # outputdir for files AND logFiles
#outputdir=/hera/hades/user/${user}/apr35/PAT/124 # outputdir for files AND logFiles
outputdir=/hera/hades/user/${user}/apr35/PAT/125 # outputdir for files AND logFiles
...
#filelist=${currentDir}/pp35_123.list  # file list in local dir! not in submissiondir!!!
#filelist=${currentDir}/pp35_124.list  # file list in local dir! not in submissiondir!!!
filelist=${currentDir}/pp35_125.list  # file list in local dir! not in submissiondir!!!
######################################################################
