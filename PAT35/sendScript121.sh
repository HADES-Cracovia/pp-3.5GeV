...
outputdir=/hera/hades/user/${user}/apr35/PAT/121pions # outputdir for files AND logFiles
...
par2=${submissiondir}/anapp121pions             # optional par2 : executable
...
filelist=${currentDir}/pp35_121.list  # file list in local dir! not in submissiondir!!!
######################################################################
