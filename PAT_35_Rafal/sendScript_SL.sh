...
submissiondir=${submmissionbase}/PAT_35_Rafal
 nFilesPerJob=1                               # number of files to be analyzed by 1 job (default==1)
    ...
    outputdir=/lustre/nyx/hades/user/knowakow/PP/PAT_35_Rafal/FILES/    # outputdir for files AND logFiles
...
par1=/lustre/nyx/hades/user/knowakow/PP/PAT_35_Rafal/profile.sh  # gen8a optional par1 : environment script
...
filelist=${currentDir}/sigma.list  # file list in local dir! not in submissiondir!!!
