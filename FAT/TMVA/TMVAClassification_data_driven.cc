...
void TMVAClassification_data(TString extraSuffix = "", Long64_t DesEntries = -1) {
  TMVA::Tools::Instance();
  ...
  TFile* outputFile = TFile::Open("TMVATraining_data_driven" + extraSuffix + ".root", "RECREATE");
...
//  MaxEntries = DesEntries;
  ...
  factory->AddSignalTree    (tSignalData,  1.);
  //factory->AddBackgroundTree(tBack, 1);
  factory->AddBackgroundTree(tBackData, 1);
