...
void TMVAClassification(TString treeFile="input_from_sim.root", TString extraSuffix = "", Long64_t DesEntries = -1) {
  TMVA::Tools::Instance();
  ...
  factory->AddVariable("m_inv_p_pim","m_inv_p_pim","MeV",'F',1000,1800);
           
  //factory->AddSpectator("m_inv_p_pim_pip_pim","m_inv_p_pim_pip_pim","MeV",'F',1300,1900);
...
Long64_t MaxEntries = TMath::Min(tSigAll->GetEntries(), tBackAll->GetEntries());
  ...
  */
  ...
  factory->BookMethod(TMVA::Types::kMLP, "kMLP_pca_mse_300_3x_n+1", "!H:!V:NCycles=300:HiddenLayers=N+1,N,N+1:NeuronType=sigmoid:NeuronInputType=sum:EstimatorType=MSE:TrainingMethod=BP:VarTransform=N,P:BPMode=sequential");

  factory->BookMethod(TMVA::Types::kMLP, "kMLP_pca_ce_300_4x_n+5_no_ev", "!H:!V:NCycles=300:HiddenLayers=N,N+5,N+5,N:NeuronType=sigmoid:NeuronInputType=sum:EstimatorType=CE:TrainingMethod=BP:VarTransform=N,P:BPMode=sequential");

  factory->BookMethod(TMVA::Types::kMLP, "kMLP_pca_ce_200_2x_n-6", "!H:!V:NCycles=200:HiddenLayers=N-6,N-6:NeuronType=sigmoid:NeuronInputType=sum:EstimatorType=CE:TrainingMethod=BP:VarTransform=N,P:BPMode=sequential:CalculateErrors=True");
  ...
  // Comparison
  //factory->BookMethod( factory, TMVA::Types::kPDEFoam, "PDEFoam","!H:!V:SigBgSeparate=F:TailCut=0.001:VolFrac=0.0666:nActiveCells=500:nSampl=2000:nBin=5:Nmin=100:Kernel=None:Compress=T" );
 //factory->BookMethod( factory, TMVA::Types::kBDT, "BDTG","!H:!V:NTrees=1000:MinNodeSize=2.5%:BoostType=Grad:Shrinkage=0.10:UseBaggedBoost:BaggedSampleFraction=0.5:nCuts=20:MaxDepth=2" );
 //factory->BookMethod( factory, TMVA::Types::kBDT, "BDT", "!H:!V:NTrees=850:MinNodeSize=2.5%:MaxDepth=3:BoostType=AdaBoost:AdaBoostBeta=0.5:UseBaggedBoost:BaggedSampleFraction=0.5:SeparationType=GiniIndex:nCuts=20" );

  //factory->BookMethod( factory, TMVA::Types::kPDEFoam, "PDEFoamBoost","!H:!V:Boost_Num=30:Boost_Transform=linear:SigBgSeparate=F:MaxDepth=4:UseYesNoCell=T:DTLogic=MisClassificationError:FillFoamWithOrigWeights=F:TailCut=0:nActiveCells=500:nBin=20:Nmin=400:Kernel=None:Compress=T" );
