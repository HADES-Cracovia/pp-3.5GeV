#define make_signal_from_sim_cxx
#include "make_signal_from_sim.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <iostream>
void make_signal_from_sim::Loop()
{
  //   In a ROOT session, you can do:
  //      Root > .L make_signal_from_sim.C
  //      Root > make_signal_from_sim t
  ...
  TFile* outputFile = new TFile("signal_from_sim.root","recreate");
  if ( outputFile == 0 )
    {
