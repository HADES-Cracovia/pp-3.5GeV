...
#ifndef make_background_from_sim_h
#define make_background_from_sim_h
...
class make_background_from_sim {
public :
   ...
   make_background_from_sim(TTree *tree=0);
   virtual ~make_background_from_sim();
...
#ifdef make_background_from_sim_cxx
make_background_from_sim::make_background_from_sim(TTree *tree) : fChain(0) 
{
...
make_background_from_sim::~make_background_from_sim()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t make_background_from_sim::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t make_background_from_sim::LoadTree(Long64_t entry)
{
...
void make_background_from_sim::Init(TTree *tree)
{
...
Bool_t make_background_from_sim::Notify()
{
...
void make_background_from_sim::Show(Long64_t entry)
{
...
Int_t make_background_from_sim::Cut(Long64_t entry)
{
...
#endif // #ifdef make_background_from_sim_cxx
