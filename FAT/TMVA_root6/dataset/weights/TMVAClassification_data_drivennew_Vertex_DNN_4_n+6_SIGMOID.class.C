...
Method         : DNN::DNN_4_n+6_SIGMOID
TMVA Release   : 4.2.1         [262657]
ROOT Release   : 6.12/06       [396294]
Creator        : knowakow
Date           : Fri Dec 20 18:08:59 2019
...
Layout: "SIGMOID|17,SIGMOID|17,SIGMOID|17,SIGMOID|17" [Layout of the network.]
# Default:
...
class ReadDNN_4_n+6_SIGMOID : public IClassifierReader {

 public:

   // constructor
   ReadDNN_4_n+6_SIGMOID( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadDNN_4_n+6_SIGMOID" ),
        fNvars( 11 ),
        fIsNormalised( false )
   {      
 ...
 private:
   ...
   inline double ReadDNN_4_n+6_SIGMOID::GetMvaValue( const std::vector<double>& inputValues ) const
   {
...
inline void ReadDNN_4_n+6_SIGMOID::InitTransform_1()
{
...
//_______________________________________________________________________
inline void ReadDNN_4_n+6_SIGMOID::Transform_1( std::vector<double>& iv, int cls) const
{
...
//_______________________________________________________________________
inline void ReadDNN_4_n+6_SIGMOID::X2P_2( const double* x, double* p, int index ) const
{
...
//_______________________________________________________________________
inline void ReadDNN_4_n+6_SIGMOID::InitTransform_2()
{
...
//_______________________________________________________________________
inline void ReadDNN_4_n+6_SIGMOID::Transform_2( std::vector<double>& iv, int cls ) const
{
   // PCA transformation
   const int nVar = 11;
...
//_______________________________________________________________________
inline void ReadDNN_4_n+6_SIGMOID::InitTransform()
{
   InitTransform_1();
   InitTransform_2();
}
...
//_______________________________________________________________________
inline void ReadDNN_4_n+6_SIGMOID::Transform( std::vector<double>& iv, int sigOrBgd ) const
{
