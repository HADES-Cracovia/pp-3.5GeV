...
Method         : DNN::DNN_4_n+6_RELU
TMVA Release   : 4.2.1         [262657]
ROOT Release   : 6.12/06       [396294]
Creator        : knowakow
Date           : Fri Dec 20 17:56:06 2019
...
Layout: "RELU|17,RELU|17,RELU|17,RELU|17" [Layout of the network.]
# Default:
...
class ReadDNN_4_n+6_RELU : public IClassifierReader {

 public:

   // constructor
   ReadDNN_4_n+6_RELU( std::vector<std::string>& theInputVars ) 
      : IClassifierReader(),
        fClassName( "ReadDNN_4_n+6_RELU" ),
        fNvars( 11 ),
        fIsNormalised( false )
   {      
 ...
 private:
   ...
   inline double ReadDNN_4_n+6_RELU::GetMvaValue( const std::vector<double>& inputValues ) const
   {
...
inline void ReadDNN_4_n+6_RELU::InitTransform_1()
{
...
//_______________________________________________________________________
inline void ReadDNN_4_n+6_RELU::Transform_1( std::vector<double>& iv, int cls) const
{
...
//_______________________________________________________________________
inline void ReadDNN_4_n+6_RELU::X2P_2( const double* x, double* p, int index ) const
{
...
//_______________________________________________________________________
inline void ReadDNN_4_n+6_RELU::InitTransform_2()
{
...
//_______________________________________________________________________
inline void ReadDNN_4_n+6_RELU::Transform_2( std::vector<double>& iv, int cls ) const
{
   // PCA transformation
   const int nVar = 11;
...
//_______________________________________________________________________
inline void ReadDNN_4_n+6_RELU::InitTransform()
{
   InitTransform_1();
   InitTransform_2();
}
...
//_______________________________________________________________________
inline void ReadDNN_4_n+6_RELU::Transform( std::vector<double>& iv, int sigOrBgd ) const
{
