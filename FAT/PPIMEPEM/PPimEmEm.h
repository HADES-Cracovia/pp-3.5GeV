...
public :
  ...
  */  
  ...
  Float_t         em2_dedx_in;
  Float_t         em2_dedx_in_sigma;
  Float_t         em2_dedx_mdc;
  Float_t         em2_dedx_mdc_sigma;
  Float_t         em2_dedx_out;
  Float_t         em2_dedx_out_sigma;
  ...
  /*
    Float_t         em2_sim_corrflag;
    Float_t         em2_sim_geninfo;
    Float_t         em2_sim_geninfo1;
    Float_t         em2_sim_geninfo2;
    Float_t         em2_sim_genweight;
    Float_t         em2_sim_id;
    Float_t         em2_sim_iscommon;
    Float_t         em2_sim_mediumid;
    Float_t         em2_sim_p;
    Float_t         em2_sim_parentid;
    Float_t         em2_sim_primaryflag;
    Float_t         em2_sim_processid;
    Float_t         em2_sim_px;
    Float_t         em2_sim_py;
    Float_t         em2_sim_pz;
    Float_t         em2_sim_vertexx;
    Float_t         em2_sim_vertexy;
    Float_t         em2_sim_vertexz;
  */  
  Float_t         em2_system;
  Float_t         em2_theta;
  Float_t         em2_tof_exp;
  Float_t         em2_tof_mom;
  Float_t         em2_tof_new;
  Float_t         em2_tofino_mult;
  Float_t         em2_track_length;
  Float_t         em2_z;
  Float_t         em1_beta;
  Float_t         em1_beta_new;
  Float_t         em1_dedx_in;
  Float_t         em1_dedx_in_sigma;
  Float_t         em1_dedx_mdc;
  Float_t         em1_dedx_mdc_sigma;
  Float_t         em1_dedx_out;
  Float_t         em1_dedx_out_sigma;
  ...
  /*
    Float_t         em1_sim_corrflag;
    Float_t         em1_sim_geninfo;
    Float_t         em1_sim_geninfo1;
    Float_t         em1_sim_geninfo2;
    Float_t         em1_sim_genweight;
    Float_t         em1_sim_id;
    Float_t         em1_sim_iscommon;
    Float_t         em1_sim_mediumid;
    Float_t         em1_sim_p;
    Float_t         em1_sim_parentid;
    Float_t         em1_sim_primaryflag;
    Float_t         em1_sim_processid;
    Float_t         em1_sim_px;
    Float_t         em1_sim_py;
    Float_t         em1_sim_pz;
    Float_t         em1_sim_vertexx;
    Float_t         em1_sim_vertexy;
    Float_t         em1_sim_vertexz;
  */  
  Float_t         em1_system;
  Float_t         em1_theta;
  Float_t         em1_tof_exp;
  ...
  */  
  ...
  TBranch        *b_em2_dedx_in;   //!
  TBranch        *b_em2_dedx_in_sigma;   //!
  TBranch        *b_em2_dedx_mdc;   //!
  TBranch        *b_em2_dedx_mdc_sigma;   //!
  TBranch        *b_em2_dedx_out;   //!
  TBranch        *b_em2_dedx_out_sigma;   //!
  TBranch        *b_em2_dedx_tof;   //!
  TBranch        *b_em2_id;   //!
  TBranch        *b_em2_isring;   //!
  TBranch        *b_em2_kIsLepton;   //!
  TBranch        *b_em2_kIsUsed;   //!
  TBranch        *b_em2_mdcchi2;   //!
  ...
  /*
    TBranch        *b_em2_sim_corrflag;   //!
    TBranch        *b_em2_sim_geninfo;   //!
    TBranch        *b_em2_sim_geninfo1;   //!
    TBranch        *b_em2_sim_geninfo2;   //!
    TBranch        *b_em2_sim_genweight;   //!
    TBranch        *b_em2_sim_id;   //!
    TBranch        *b_em2_sim_iscommon;   //!
    TBranch        *b_em2_sim_mediumid;   //!
    TBranch        *b_em2_sim_p;   //!
    TBranch        *b_em2_sim_parentid;   //!
    TBranch        *b_em2_sim_primaryflag;   //!
    TBranch        *b_em2_sim_processid;   //!
    TBranch        *b_em2_sim_px;   //!
    TBranch        *b_em2_sim_py;   //!
    TBranch        *b_em2_sim_pz;   //!
    TBranch        *b_em2_sim_vertexx;   //!
    TBranch        *b_em2_sim_vertexy;   //!
    TBranch        *b_em2_sim_vertexz;   //!
  */  
  TBranch        *b_em2_system;   //!
  TBranch        *b_em2_theta;   //!
  TBranch        *b_em2_tof_exp;   //!
  TBranch        *b_em2_tof_mom;   //!
  TBranch        *b_em2_tof_new;   //!
  TBranch        *b_em2_tofino_mult;   //!
  TBranch        *b_em2_track_length;   //!
  TBranch        *b_em2_z;   //!
  TBranch        *b_em1_beta;   //!
  TBranch        *b_em1_beta_new;   //!
  TBranch        *b_em1_dedx_in;   //!
  TBranch        *b_em1_dedx_in_sigma;   //!
  TBranch        *b_em1_dedx_mdc;   //!
  TBranch        *b_em1_dedx_mdc_sigma;   //!
  TBranch        *b_em1_dedx_out;   //!
  TBranch        *b_em1_dedx_out_sigma;   //!
  TBranch        *b_em1_dedx_tof;   //!
  TBranch        *b_em1_id;   //!
  TBranch        *b_em1_isring;   //!
  TBranch        *b_em1_kIsLepton;   //!
  TBranch        *b_em1_kIsUsed;   //!
  TBranch        *b_em1_mdcchi2;   //!
  ...
  /*
    TBranch        *b_em1_sim_corrflag;   //!
    TBranch        *b_em1_sim_geninfo;   //!
    TBranch        *b_em1_sim_geninfo1;   //!
    TBranch        *b_em1_sim_geninfo2;   //!
    TBranch        *b_em1_sim_genweight;   //!
    TBranch        *b_em1_sim_id;   //!
    TBranch        *b_em1_sim_iscommon;   //!
    TBranch        *b_em1_sim_mediumid;   //!
    TBranch        *b_em1_sim_p;   //!
    TBranch        *b_em1_sim_parentid;   //!
    TBranch        *b_em1_sim_primaryflag;   //!
    TBranch        *b_em1_sim_processid;   //!
    TBranch        *b_em1_sim_px;   //!
    TBranch        *b_em1_sim_py;   //!
    TBranch        *b_em1_sim_pz;   //!
    TBranch        *b_em1_sim_vertexx;   //!
    TBranch        *b_em1_sim_vertexy;   //!
    TBranch        *b_em1_sim_vertexz;   //!
  */  
  TBranch        *b_em1_system;   //!
  TBranch        *b_em1_theta;   //!
  TBranch        *b_em1_tof_exp;   //!
  TBranch        *b_em1_tof_mom;   //!
  TBranch        *b_em1_tof_new;   //!
  TBranch        *b_em1_tofino_mult;   //!
