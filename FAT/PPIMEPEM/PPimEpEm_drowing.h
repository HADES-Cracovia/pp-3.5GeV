...
// Wed Apr  8 20:52:11 2020 by ROOT version 5.34/36
// from TTree ppimepem/ppimepem
// found on file: pp_fullstat_ppimepep.root
//////////////////////////////////////////////////////////

#ifndef PPimEpEm_drowing_h
#define PPimEpEm_drowing_h
...
public :
   ...
   PPimEpEm_drowing(TTree *tree=0);
   virtual ~PPimEpEm_drowing();
...
#ifdef PPimEpEm_drowing_cxx
PPimEpEm_drowing::PPimEpEm_drowing(TTree *tree) : fChain(0) 
{
...
PPimEpEm_drowing::~PPimEpEm_drowing()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PPimEpEm_drowing::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PPimEpEm_drowing::LoadTree(Long64_t entry)
{
...
void PPimEpEm_drowing::Init(TTree *tree)
{
...
Bool_t PPimEpEm_drowing::Notify()
{
...
void PPimEpEm_drowing::Show(Long64_t entry)
{
...
#else
    if(
       ver_p_pim_z>0-7.5//target in pp3.5 (-65,-15) in simulation (-55,-7.5)
       && dist_p_pim<20
       && oa_em_ep>4
       && trigdec==1
       && isBest==1
...
#endif // #ifdef PPimEpEm_drowing_cxx
