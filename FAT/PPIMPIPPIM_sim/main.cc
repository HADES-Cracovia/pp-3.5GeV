...
int main()
{
  ...
  *beam = *proj + *targ;
  ...
  /************************************** O U T P U T   F I L E ******************************************/
  outFileData=new TFile("L1520_Spi_Lpipi.root","recreate");
  //outFileData=new TFile("urqmd_pNb_christian.root","recreate");
  //outFileData=new TFile("SsPipKz_thermal_125_600.root","recreate");
  //outFileData=new TFile("SsPimKz_thermal_125_600.root","recreate");
  //outFileData=new TFile("L1520_thermal_125_600.root","recreate");
  //outFileData=new TFile("SsPimKz_thermal.root","recreate");
  //outFileData=new TFile("L1520K0_thermal.root","recreate");
