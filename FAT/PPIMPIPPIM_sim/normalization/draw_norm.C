...
int draw_norm(void)
{
  ...
  TFile *fileL1520= new TFile("./../StatisticalTest/output_old_results_the_best.root","READ");
  TFile *fileExp= new TFile("/lustre/hades/user/knowakow/PP/FAT/PPIMPIPPIM/StatisticalTest/output_old_results_the_best.root","READ");
