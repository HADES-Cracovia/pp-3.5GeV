...
void PPimPipPim::Loop()
{
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++)
      ...
      if(isBest>=0 /*&& trigdownscaleflag==1*/)
	{
	  ...
	  (*n_out)["p_sim_vertex_x"]=p_sim_vertexx;
	  (*n_out)["p_sim_vertex_y"]=p_sim_vertexy;
	  (*n_out)["p_sim_vertex_z"]=p_sim_vertexz;
	  ...
	  (*n_out)["pip_sim_vertex_x"]=pip_sim_vertexx;
	  (*n_out)["pip_sim_vertex_y"]=pip_sim_vertexy;
	  (*n_out)["pip_sim_vertex_z"]=pip_sim_vertexz;
	  ...
	  (*n_out)["pim1_sim_vertex_x"]=pim1_sim_vertexx;
	  (*n_out)["pim1_sim_vertex_y"]=pim1_sim_vertexy;
	  (*n_out)["pim1_sim_vertex_z"]=pim1_sim_vertexz;
	  ...
	  (*n_out)["pim2_sim_vertex_x"]=pim2_sim_vertexx;
	  (*n_out)["pim2_sim_vertex_y"]=pim2_sim_vertexy;
	  (*n_out)["pim2_sim_vertex_z"]=pim2_sim_vertexz;
