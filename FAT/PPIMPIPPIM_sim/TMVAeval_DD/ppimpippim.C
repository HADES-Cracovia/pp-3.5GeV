...
void ppimpippim::Loop()
{
  ...
  //TFile* outFileData = new TFile("pp_after_TMVA_DD_6_n+4_pNb_newVertex_L1520_thermal_125_600.root","recreate");
  //TFile* outFileData = new TFile("pp_after_TMVA_DD_6_n+4_pNb_newVertex_L1520K0_thermal.root","recreate");
  TFile* outFileData = new TFile("pp_after_TMVA_DD_6_n+4_pNb_newVertex_SsPimKz_thermal_125_600.root","recreate");
