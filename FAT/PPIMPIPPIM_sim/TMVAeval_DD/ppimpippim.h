  ...
  if (tree == 0)
    {
      ...
      //TFile *f=(TFile*)gROOT->GetListOfFiles()->FindObject("../L1520_thermal_125_600.root");
      //TFile *f=(TFile*)gROOT->GetListOfFiles()->FindObject("../L1520K0_thermal.root");
      TFile *f=(TFile*)gROOT->GetListOfFiles()->FindObject("../SsPimKz_thermal_125_600.root");
      if (!f || !f->IsOpen())
	{
	  //f = new TFile("../L1520_thermal_125_600.root");
	  //f = new TFile("../L1520K0_thermal.root");
	  f = new TFile("../SsPimKz_thermal_125_600.root");
	}
