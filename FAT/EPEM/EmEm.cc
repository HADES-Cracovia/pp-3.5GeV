  ...
  */
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++) {
    ...
    */
    ...
    bool flanch=!(em1_theta>65 && eVert_z<-45) && !(em2_theta>65 && eVert_z<-45);
    ...
    bool mass_condition=(em1_p>80 && em2_p>80 && em1_p <2000. && em2_p <2000.
			 //&& em_p>200 && em_p>200
			 //&&(em_system==0?em_beta_new>0.95:em_beta_new>0.92)&&(em_system==0?em_beta_new>0.95:em_beta_new>0.92)
			 //&& em1_beta_new<1.1 && em2_beta_new<1.1
			 && em1_beta_new>0.9 && em2_beta_new>0.9
			 && pre_shower
			 && flanch
			 );
    int i_array;
	...
	*/
	...
	if(em1_isring>0 && em2_isring>0 && mass_condition)
	  { // [1]
	    ...
	    z_theta_emem->Fill(eVert_z,em1_theta);
	    z_theta_emem->Fill(eVert_z,em2_theta);
	    z_theta_all->Fill(eVert_z,em1_theta);
	    z_theta_all->Fill(eVert_z,em2_theta);
	    //em2_mom->Fill(em2_p);
	    //em1_mom->Fill(em1_p);
...
EmEm::EmEm(TTree *tree)
{
  ...
  if (tree == 0) {
    ...
    //chain->Add("/lustre/nyx/hades/user/knowakow/PP/PAT/FILES/115_combinatorics/lepton.root/EmEm_ID");
    chain->Add("/lustre/nyx/hades/user/knowakow/PP/PAT/FILES/full_stat/leptons.root/EmEm_ID");
    ...
    chain->Add("/lustre/nyx/hades/user/knowakow/PP/PAT_1/FILES/bt/lepton00.root/EmEm_ID");
    chain->Add("/lustre/nyx/hades/user/knowakow/PP/PAT_1/FILES/bt/lepton01.root/EmEm_ID");
    chain->Add("/lustre/nyx/hades/user/knowakow/PP/PAT_1/FILES/bt/lepton02.root/EmEm_ID");
    chain->Add("/lustre/nyx/hades/user/knowakow/PP/PAT_1/FILES/bt/lepton03.root/EmEm_ID");
    chain->Add("/lustre/nyx/hades/user/knowakow/PP/PAT_1/FILES/bt/lepton04.root/EmEm_ID");
    chain->Add("/lustre/nyx/hades/user/knowakow/PP/PAT_1/FILES/bt/lepton05.root/EmEm_ID");
    chain->Add("/lustre/nyx/hades/user/knowakow/PP/PAT_1/FILES/bt/lepton06.root/EmEm_ID");
    chain->Add("/lustre/nyx/hades/user/knowakow/PP/PAT_1/FILES/bt/lepton07.root/EmEm_ID");
    chain->Add("/lustre/nyx/hades/user/knowakow/PP/PAT_1/FILES/bt/lepton08.root/EmEm_ID");
    chain->Add("/lustre/nyx/hades/user/knowakow/PP/PAT_1/FILES/bt/lepton09.root/EmEm_ID");
    chain->Add("/lustre/nyx/hades/user/knowakow/PP/PAT_1/FILES/bt/lepton10.root/EmEm_ID");
    chain->Add("/lustre/nyx/hades/user/knowakow/PP/PAT_1/FILES/bt/lepton11.root/EmEm_ID");
    tree = chain;
