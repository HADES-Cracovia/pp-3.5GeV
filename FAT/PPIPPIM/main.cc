...
int main()
{
  ...
  *beam = *proj + *targ;
  ...
  gammapimpip = new TLorentzVector(0,0,0,0);
  ...
  /************************************** O U T P U T   F I L E ******************************************/
  outFileData = new TFile("pNb_ppimpip_full_stat.root","recreate");
  //ofstream myfile;
  ...
  //pim_pip_mass=new TH1F("pim_pip_mass","Invariant mass #pi_{1}^{-} #pi^{+} ",2000,200,1500);
  p_pim_pip_mass=new TH1F("p_pim_pip_pim_mass","Invariant mass #pi^{-} #pi^{+} p #pi^{-}",2000,1000,2000);

  dist_p_pim_pip=new TH2F("dist_p_pim_pim_pip","dist_p_pim_pim_pip",300,0,300,300,0,300);
  ...
  //DL_pim_pip_mass=new TH1F("DL_pim_pip_mass","DL_Invariant mass #pi_{1}^{-} #pi^{+} ",2000,200,1500);
  DL_p_pim_pip_mass=new TH1F("DL_p_pim_pip_pim_mass","DL_Invariant mass #pi^{-} #pi^{+} p #pi^{-}",2000,1000,2000);

  DL_dist_p_pim_pip=new TH2F("DL_dist_p_pim_pim_pip","DL_dist_p_pim_pim_pip",300,0,300,300,0,300);
  ...
  //DML_pim_pip_mass=new TH1F("DML_pim_pip_mass","DML_Invariant mass #pi_{1}^{-} #pi^{+} ",2000,200,1500);
  DML_p_pim_pip_mass=new TH1F("DML_p_pim_pip_pim_mass","DML_Invariant mass #pi^{-} #pi^{+} p ",2000,1000,2000);

  //DML_dist_p_pim_pip=new TH2F("DML_dist_p_pim_pim_pip","DML_dist_p_pim_pim_pip",300,0,300,300,0,300);
  ...
  cout << "START PPipPim!" << endl;
  t2.Loop();
  cout << "STOP PPipPim!!" << endl;
  ...
  //pim2_pip_mass->Write();
  // pim_pip_mass->Write();
  p_pim_pip_mass->Write();
  miss_energy->Write();
  
  dist_p_pim_pip->Write();
  dist_pim_pip->Write();
  dist_p_pim->Write();
  ...
  //DL_pim_pip_mass->Write();
  DL_p_pim_pip_mass->Write();

  DL_dist_p_pim_pip->Write();
  ...
  //DML_pim_pip_mass->Write();
  DML_p_pim_pip_mass->Write();

  //DML_dist_p_pim_pip->Write();
