...
namespace PATData
{
  ...
  TH1F *pim_pip_mass, *p_pim_pip_mass;
  TH2F *dist_p_pim_pip;
  TH1F *dist_p_pim, *dist_pim_pip;

  TH1F *miss_energy, *DL_miss_energy, *DML_miss_energy;

  TH1F *DL_p_pim_mass, *DL_pim_pip_mass,*DL_p_pim_pip_mass;
  TH1F *DL_dist_p_pim, *DL_dist_pim_pip;
  TH2F *DL_dist_p_pim_pip;
  TH1F *DL_p_mass, *DL_pim_mass;
  
  TH1F *DML_p_pim_mass, *DML_pim_pip_mass, *DML_p_pim_pip_mass;
