...
// Thu Aug  8 13:44:49 2019 by ROOT version 5.34/34
// from TTree ppimpippim/ppimpippim_after TMVA
// found on file: ../TMVAeval_DD/pp_after_TMVA_DD_6_n+4_pp_Lpippim_check.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0)
     {
       TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../TMVAeval_DataDriven/pp_after_TMVA_DD_6n+4_from_pp.root");
       if (!f || !f->IsOpen())
	 {
	   f = new TFile("../TMVAeval_DataDriven/pp_after_TMVA_DD_6n+4_from_pp.root");
	 }
