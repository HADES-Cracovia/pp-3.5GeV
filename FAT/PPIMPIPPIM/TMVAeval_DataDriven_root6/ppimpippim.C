...
void ppimpippim::Loop()
{
  ...
  TFile* outFileData = new TFile("temp1.root","recreate");
  HNtuple *n_out = new HNtuple("ppimpippim","ppimpippim_after KNN");
  ...
  reader->BookMVA("KNN","/lustre/hades/user/knowakow/PP/FAT/TMVA_root6/dataset/weights/TMVAClassification_data_drivennew_Vertex_kNN_30.weights.xml");
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++)
	...
	cout<<(double)jentry/nentries *100<<"%"<<endl;
      ...
      Double_t mlp_output=reader->EvaluateMVA("KNN");
