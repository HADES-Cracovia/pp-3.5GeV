...
int run_all(void)
{
  ...
  f_sb_experiment->GetObject("ppimpippim",t_sb_experiment);
  f_sb_sim_SDppK0->GetObject("ppimpippim",t_sb_sim_SDppK0);
  f_sb_sim_S1385pK0->GetObject("ppimpippim",t_sb_sim_S1385pK0);
  f_sb_sim_LDppK0->GetObject("ppimpippim",t_sb_sim_LDppK0);
  f_sb_sim_L1520pippim->GetObject("ppimpippim",t_sb_sim_L1520pippim);
