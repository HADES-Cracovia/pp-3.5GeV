...
submmissionbase=/lustre/nyx/hades/user/przygoda/ACCEPTANCE
submissiondir=${submmissionbase}/LEPTONS
 nFilesPerJob=1                               # number of files to be analyzed by 1 job (default==1)
    ...
    outputdir=/lustre/nyx/hades/user/przygoda/apr06/acc/NEW_PWA/3PRONG/NEW/     # outputdir for files AND logFiles
...
par1=/cvmfs/hades.gsi.de/install/5.34.34/old/hydra-11042016/defall.sh  # gen8a optional par1 : environment script
par2=${submissiondir}/acc                           # optional par2 : executable
...
jobarrayFile="pp_acc_jobarray.dat"

#filelist=${currentDir}/PWA_delta_pi0dalitz.list  # file list in local dir! not in submissiondir!!!
filelist=${currentDir}/PWA_delta_dalitz.list  # file list in local dir! not in submissiondir!!!
#filelist=${currentDir}/PWA_total_pi0dalitz.list  # file list in local dir! not in submissiondir!!!
#filelist=${currentDir}/PWA_delta_dalitz_pena1500big.list  # file list in local dir! not in submissiondir!!!
#filelist=${currentDir}/PWA_delta_dalitz_pena1500big-bare.list  # file list in local dir! not in submissiondir!!!
#filelist=${currentDir}/PWA_delta_dalitz_pena1500big-pion.list  # file list in local dir! not in submissiondir!!!
#filelist=${currentDir}/PWA_brems.list  # file list in local dir! not in submissiondir!!!
