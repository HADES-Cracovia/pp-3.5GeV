...
submissiondir=${submmissionbase}/PAT35
 nFilesPerJob=1                               # number of files to be analyzed by 1 job (default==1)
    ...
    outputdir=/lustre/nyx/hades/user/knowakow/PP/PAT35/FILES/day_120/    # outputdir for files AND logFiles
...
par1=/lustre/nyx/hades/user/knowakow/PP/PAT35/set64.sh  # gen8a optional par1 : environment script
par2=${submissiondir}/anapp120pions                           # optional par2 : executable
...
filelist=${currentDir}/list120.list  # file list in local dir! not in submissiondir!!!
