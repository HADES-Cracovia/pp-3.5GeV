...
submissiondir=${submmissionbase}/PAT_sim
 nFilesPerJob=1                               # number of files to be analyzed by 1 job (default==1)
    ...
    outputdir=/lustre/nyx/hades/user/knowakow/PP/PAT_sim/FILES/pippimL_ver3_bis/    # outputdir for files AND logFiles
...
filelist=${currentDir}/pippimL_bis.list  # file list in local dir! not in submissiondir!!!
