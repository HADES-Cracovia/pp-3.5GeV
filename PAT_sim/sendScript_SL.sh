...
submissiondir=${submmissionbase}/PAT_sim
 nFilesPerJob=1                               # number of files to be analyzed by 1 job (default==1)
    ...
    outputdir=/lustre/nyx/hades/user/knowakow/PP/PAT_sim/FILES//    # outputdir for files AND logFiles
...
filelist=${currentDir}/all.list  # file list in local dir! not in submissiondir!!!
