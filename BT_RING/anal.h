...
// Thu Feb 15 15:49:47 2018 by ROOT version 5.34/30
// from TTree PEpEm_ID/PEpEm_ID
// found on file: sum_hadron_new.root
//////////////////////////////////////////////////////////
...
#ifdef anal_cxx
anal::anal(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("sum_hadron_new.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("sum_hadron_new.root");
      }
