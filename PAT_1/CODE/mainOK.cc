...
int main(Int_t argc, Char_t **argv)
{
    ...
    //TString inputDir  ="/lustre/hades/user/przygoda/apr06/gen3/";
    //TString inputDir  ="/lustre/hades/user/przygoda/apr07/gen2/";
    //`TString inputDir  ="/lustre/hades/user/przygoda/apr06/dst/"; // two-pion
    //TString inputDir  ="/lustre/hades/user/sudol/np125/dst_gen2/";
    //TString inputDir  ="/hera/hades/user/przygoda/apr06/dst_sim/files/ppip063/";
    //TString inputDir  ="/hera/hades/user/przygoda/apr06/dst_sim/files/npip063/";
    //--- for dileptons
    // ****************
    //TString inputDir  ="/lustre/hades/user/beatam/dst_sim/files/NEW_delta_PS/";
    ...
    //TString inputDir  ="/hera/hades/user/przygoda/apr06/dst_sim/files/NEW_N1440_pi0_dalitz/";
    //--- for model
    //TString inputDir  ="/hera/hades/user/przygoda/apr06/dst_sim/files/NEW_N1440_npip/";
    //TString inputDir  ="/hera/hades/user/przygoda/apr06/dst_sim/files/ppi0_L063/";
    //TString inputDir  ="/lustre/hades/user/beatam/dst_sim/files/ppi0_L100/";
    ...
    //TString inputDir  ="/lustre/hades/user/sudol/ValenciaModel/new/dst/";
    ...
    //TString inputDir  ="/lustre/hades/user/sudol/ValenciaModel/dst/";
    // **** MAM DOSC
    //TString inputDir  ="/lustre/hades/user/beatam/dst_sim/files/ppip075_TRIG/";
    //TString inputDir  ="/lustre/hades/user/beatam/dst_sim/files/ppip075_NOTRIG/";
    ...
    //TString inputDir  ="/lustre/hades/user/sudol/XuCao/pp/dst/";
    // *** PWA *** SIM *** (phasespace) ***
    //TString inputDir  ="/lustre/hades/user/beatam/dst_sim/files/PWA_ps_pip/";
    //TString inputDir  ="/lustre/hades/user/beatam/dst_sim/files/PWA_ps_pi0/";
    //TString inputDir  ="/hera/hades/user/przygoda/apr06/dst_sim/files/PWA_ps_pip/";
    //TString inputDir  ="/hera/hades/user/przygoda/apr06/dst_sim/files/PWA_ps_pi0/";
    //
    ...
    //TString inputDir  ="/lustre/hades/user/beatam/dst_sim/files/ppi0_NOTRIG/";
    //TString inputDir  ="/lustre/hades/user/wisnia/apr06/dst/";
    //TString inputDir  ="/lustre/hades/user/beatam/dst_sim/files/pp_elastic/";
    //TString inputDir  ="/lustre/hades/user/beatam/dst_sim/files/NEW_pp_elastic/";
    ...
    //   TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/all_new_PPIP/OK/";
    //   TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/all_new_PPPIPPIM/";
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/all_new_PPP/";
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/ppip075_fake/";
    // --- for dileptons
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_lepton/NEW_delta_PS/";
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_lepton/NEW_delta_L063_ALL/";
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_lepton/NEW_delta_L063_VMD/";
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_lepton/NEW_delta_L100_PI0/";
    //TString output_Dir  ="/hera/hades/user/przygoda/apr06/pat_lepton/NEW_N1440_pi0_dalitz/";
    // ---- for model
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/ppip075_NOTRIG_inCuts/";
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/ppip075_TRIG_LVL/";
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/ppip075_NOTRIG_LVL/";
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/npip075_NOTRIG/";
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/ppip100_newCut/";
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/npip100_newCut/";
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/ppipFLAT_newCut/";
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/npipFLAT_newCut/";
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/PPIP/xucao_newCut_3prong/";
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/PPIP/valencia_newCut_3prong/";
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/PPIP/valenciaOLD_newCut_3prong/";
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/npip075_newCut/";
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/PPIP/ppip075_newCut/";
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/PPIP/ppip075_ideal/";
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/PPIP/npip075_newCut/";
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/PPIP/npip075_ideal/";
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/PPIP/N1440_npip_newCut/";
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/PPI0/ppi0075_newCut/";
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/PPI0/ppi0100_newCut/";
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/PPI0/N1440_ppi0_newCut/";
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/ppi0_NOTRIG/";
    ...
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/NEW_pp_elastic/";
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/NEW_pp_elastic_exp/";
    // *** PWA *** SIM *** (phasespace) ***
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/PWA_ps_pip/";
    //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/PWA_ps_pi0/";
    //TString output_Dir  ="/hera/hades/user/przygoda/apr06/pat_hadron/PWA_ps_pip/";
    TString output_Dir  ="/hera/hades/user/przygoda/apr06/pat_hadron/PWA_ps_pi0/";
    ...
    //
    //TString output_Dir   = "/lustre/hades/user/przygoda/apr07/pat_hadron/nopid2/";
    //TString output_Dir   = "/lustre/hades/user/przygoda/apr06/dst/pat/";
    // ************ modified DELTA ditribution 
    //TString output_Dir   = "/lustre/hades/user/przygoda/apr06/pat_hadron/NEW_delta_Luser_PPI0/";
    //TString output_Dir   = "/hera/hades/user/przygoda/apr06/pat_hadron/PPIP/ppip063_newCut/";
    //TString output_Dir   = "/hera/hades/user/przygoda/apr06/pat_hadron/PPIP/npip063_newCut/";
    //TString output_Dir   = "/hera/hades/user/przygoda/apr06/pat_hadron/PPI0/NEW_N1440_ppi0_newCut/";
    //TString output_Dir   = "/hera/hades/user/przygoda/apr06/pat_hadron/PPIP/NEW_N1440_npip_newCut/";
    ...
    HGraphCut tCut3("all","/hera/hades/user/przygoda/PAT64/p_pip_cuts_LAST.root"); // mass^2 versus mom
