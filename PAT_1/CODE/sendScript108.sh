...
outputdir=/hera/hades/user/${user}/apr35/PAT/108pions # outputdir for files AND logFiles
...
par2=${submissiondir}/anapp108pions             # optional par2 : executable
...
filelist=${currentDir}/pp35_108.list  # file list in local dir! not in submissiondir!!!
######################################################################
