...
outputdir=/hera/hades/user/${user}/apr35/PAT/113pions # outputdir for files AND logFiles
...
par2=${submissiondir}/anapp113pions             # optional par2 : executable
...
filelist=${currentDir}/pp35_113.list  # file list in local dir! not in submissiondir!!!
######################################################################
