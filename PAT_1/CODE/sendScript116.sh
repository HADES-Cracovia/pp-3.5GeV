...
outputdir=/hera/hades/user/${user}/apr35/PAT/116pions # outputdir for files AND logFiles
...
par2=${submissiondir}/anapp116pions             # optional par2 : executable
...
filelist=${currentDir}/pp35_116.list  # file list in local dir! not in submissiondir!!!
######################################################################
