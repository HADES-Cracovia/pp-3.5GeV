...
outputdir=/hera/hades/user/${user}/apr35/PAT/112pions # outputdir for files AND logFiles
...
par2=${submissiondir}/anapp112pions             # optional par2 : executable
...
filelist=${currentDir}/pp35_112.list  # file list in local dir! not in submissiondir!!!
######################################################################
