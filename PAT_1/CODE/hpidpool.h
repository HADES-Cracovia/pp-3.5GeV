...
public:
   ...
   bool add(const char* oldname, const char* name, EParticle p1, EParticle p2, EParticle p3, EParticle p4, EParticle p5);
   bool add(const char* oldname, const char* name, EParticle p1, EParticle p2, EParticle p3, EParticle p4, EParticle p5, EParticle p6);
   ...
   bool add(const char* oldname, const char* name, const char* p1, const char* p2, const char* p3, const char* p4, const char* p5);
   bool add(const char* oldname, const char* name, const char* p1, const char* p2, const char* p3, const char* p4, const char* p5, const char* p6);
