...
outputdir=/hera/hades/user/${user}/apr06/pat_hadron/PWA_ps_pi0 # outputdir for files AND logFiles
#outputdir=/hera/hades/user/${user}/apr06/pat_hadron/PWA_ps_pi0 # outputdir for files AND logFiles
...
filelist=${currentDir}/ppi0_PS.list  # file list in local dir! not in submissiondir!!!
######################################################################
