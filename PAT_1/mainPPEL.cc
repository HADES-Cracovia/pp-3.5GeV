...
int main(Int_t argc, Char_t **argv)
{
  ...
  TString inputDir  ="/lustre/hades/user/beatam/dst_sim/files/pp_elastic_NOFILTER/";
  //TString inputDir  ="/lustre/hades/user/beatam/dst_sim/files/delta1000_L063/";
  //TString inputDir  ="/tmp/";
  TString inputFile = argv[1];

  //TString output_Dir  ="/lustre/hades/user/przygoda/apr07/pat/";
  //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/npip075_sim/";
  TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_hadron/pp_elastic_NOFILTER/";
  //TString output_Dir  ="/lustre/hades/user/przygoda/apr06/pat_lepton/delta1000_L063/";
