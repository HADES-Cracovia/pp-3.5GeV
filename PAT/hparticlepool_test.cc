...
void HParticlePool::loop(HIterator* dataIt)
{
   ...
   while (((ParticleCand = (HParticleCand *) dataIt->Next()) != 0))
   {
	   ...
	   if (  isPositive && !kIsLepton ) ++hposnum;
	   if (  isPositive &&  kIsLepton ) ++lposnum;
	   if ( !isPositive && !kIsLepton ) ++hnegnum;
	   if ( !isPositive &&  kIsLepton ) ++lnegnum;
...
//	   if ( !isPositive &&  isRing ) ++lnegnum;
   ...
   while (((ParticleCand = (HParticleCand *) dataIt->Next()) != 0))
   {
      ...
      // TEMPORARY REMOVAL OF RICH !!!!
      EParticle myEId = eUnknown;
      if (isPositive && isRing) myEId = eLeptonPos;
      else if (isPositive && !kIsLepton) myEId = eHadronPos;
      else if (!isPositive && kIsLepton) myEId = eLeptonNeg;
      else if (!isPositive && !kIsLepton) myEId = eHadronNeg;
...
//-----------------------------------------------------------------------------
void HParticlePool::fill(HIterator* dataIt, HIterator *geantIt, HIterator *startIt, HIterator *pionIt) 
{
...
// -------------------------------------------------------------
    ...
    {
       startIt->Reset();
       while (((StartCand = (HStart2Hit*) startIt->Next()) != 0))
       {
          ++smult;
       ...
       HPionTrackerTrack *PTrackerCand    = 0;
       unsigned ptcounter = 0, ptmult = 0;
       Float_t a=0, b=0;
       // =========================================================
    // ----------- pion tracker data ----------------------------------
    
    // =========================================================
    if ( piontrackerflag > 0 ) 
    {
       // re-setting pion tracker data
       eventData.set("pt_p_1", -100. );
       eventData.set("pt_theta_1", -100. );
       eventData.set("pt_phi_1", -100. );
       eventData.set("pt_costh_1", -100. );
       eventData.set("pt_x1_1", -100. );
       eventData.set("pt_y1_1", -100. );
       eventData.set("pt_x2_1", -100. );
       eventData.set("pt_y2_1", -100. );
       eventData.set("pt_xtarg_1", -100. );
       eventData.set("pt_ytarg_1", -100. );
       eventData.set("pt_px_1", -100. );
       eventData.set("pt_py_1", -100. );
       eventData.set("pt_pz_1", -100. );
       eventData.set("pt_match_1", -100. );
       eventData.set("pt_theta0_1", -100. );
       eventData.set("pt_phi0_1", -100. );
       eventData.set("pt_p_2", -100. );
       eventData.set("pt_theta_2", -100. );
       eventData.set("pt_phi_2", -100. );
       eventData.set("pt_costh_2", -100. );
       eventData.set("pt_x1_2", -100. );
       eventData.set("pt_y1_2", -100. );
       eventData.set("pt_x2_2", -100. );
       eventData.set("pt_y2_2", -100. );
       eventData.set("pt_xtarg_2", -100. );
       eventData.set("pt_ytarg_2", -100. );
       eventData.set("pt_px_2", -100. );
       eventData.set("pt_py_2", -100. );
       eventData.set("pt_pz_2", -100. );
       eventData.set("pt_match_2", -100. );
       eventData.set("pt_theta0_2", -100. );
       eventData.set("pt_phi0_2", -100. );
       eventData.set("pt_p_3", -100. );
       eventData.set("pt_theta_3", -100. );
       eventData.set("pt_phi_3", -100. );
       eventData.set("pt_costh_3", -100. );
       eventData.set("pt_x1_3", -100. );
       eventData.set("pt_y1_3", -100. );
       eventData.set("pt_x2_3", -100. );
       eventData.set("pt_y2_3", -100. );
       eventData.set("pt_xtarg_3", -100. );
       eventData.set("pt_ytarg_3", -100. );
       eventData.set("pt_px_3", -100. );
       eventData.set("pt_py_3", -100. );
       eventData.set("pt_pz_3", -100. );
       eventData.set("pt_match_3", -100. );
       eventData.set("pt_theta0_3", -100. );
       eventData.set("pt_phi0_3", -100. );
       eventData.set("pt_p_4", -100. );
       eventData.set("pt_theta_4", -100. );
       eventData.set("pt_phi_4", -100. );
       eventData.set("pt_costh_4", -100. );
       eventData.set("pt_x1_4", -100. );
       eventData.set("pt_y1_4", -100. );
       eventData.set("pt_x2_4", -100. );
       eventData.set("pt_y2_4", -100. );
       eventData.set("pt_xtarg_4", -100. );
       eventData.set("pt_ytarg_4", -100. );
       eventData.set("pt_px_4", -100. );
       eventData.set("pt_py_4", -100. );
       eventData.set("pt_pz_4", -100. );
       eventData.set("pt_match_4", -100. );
       eventData.set("pt_theta0_4", -100. );
       eventData.set("pt_phi0_4", -100. );
       eventData.set("pt_mult", -100. );
       eventData.set("pt_counter", -100. );
    }

    if ( piontrackerflag > 0 && pionIt != 0 )
    {
       pionIt->Reset();
       while (((PTrackerCand = (HPionTrackerTrack*) pionIt->Next()) != 0))
       {
          ++ptmult;
          //cout << " smult " << smult << endl;
       }
       ...
       while (((PTrackerCand = (HPionTrackerTrack*) pionIt->Next()) != 0))
       {
          ++ptcounter;
          if ( ptcounter == 1 ) {
             eventData.set("pt_p_1", PTrackerCand->getP() );
             eventData.set("pt_theta_1", PTrackerCand->getTheta() );
             eventData.set("pt_phi_1", PTrackerCand->getPhi() );
             eventData.set("pt_costh_1", PTrackerCand->getCosTheta() );
             PTrackerCand->getPos1( a, b );
             eventData.set("pt_x1_1", a );
             eventData.set("pt_y1_1", b );
             PTrackerCand->getPos2( a, b );
             eventData.set("pt_x2_1", a );
             eventData.set("pt_y2_1", b );
             PTrackerCand->getPosH( a, b );
             eventData.set("pt_xtarg_1", a );
             eventData.set("pt_ytarg_1", b );
             eventData.set("pt_px_1", PTrackerCand->getPx() );
             eventData.set("pt_py_1", PTrackerCand->getPy() );
             eventData.set("pt_pz_1", PTrackerCand->getPz() );
             eventData.set("pt_theta0_1", PTrackerCand->getTheta0() );
             eventData.set("pt_phi0_1", PTrackerCand->getPhi0() );
             eventData.set("pt_match_1", PTrackerCand->getMatch() );
             eventData.set("pt_mult", ptmult );
             eventData.set("pt_counter", ptcounter );
          } else if ( ptcounter == 2 ) {
             eventData.set("pt_p_2", PTrackerCand->getP() );
             eventData.set("pt_theta_2", PTrackerCand->getTheta() );
             eventData.set("pt_phi_2", PTrackerCand->getPhi() );
             eventData.set("pt_costh_2", PTrackerCand->getCosTheta() );
             PTrackerCand->getPos1( a, b );
             eventData.set("pt_x1_2", a );
             eventData.set("pt_y1_2", b );
             PTrackerCand->getPos2( a, b );
             eventData.set("pt_x2_2", a );
             eventData.set("pt_y2_2", b );
             PTrackerCand->getPosH( a, b );
             eventData.set("pt_xtarg_2", a );
             eventData.set("pt_ytarg_2", b );
             eventData.set("pt_px_2", PTrackerCand->getPx() );
             eventData.set("pt_py_2", PTrackerCand->getPy() );
             eventData.set("pt_pz_2", PTrackerCand->getPz() );
             eventData.set("pt_theta0_2", PTrackerCand->getTheta0() );
             eventData.set("pt_phi0_2", PTrackerCand->getPhi0() );
             eventData.set("pt_match_2", PTrackerCand->getMatch() );
          } else if ( ptcounter == 3 ) {
             eventData.set("pt_p_3", PTrackerCand->getP() );
             eventData.set("pt_theta_3", PTrackerCand->getTheta() );
             eventData.set("pt_phi_3", PTrackerCand->getPhi() );
             eventData.set("pt_costh_3", PTrackerCand->getCosTheta() );
             PTrackerCand->getPos1( a, b );
             eventData.set("pt_x1_3", a );
             eventData.set("pt_y1_3", b );
             PTrackerCand->getPos2( a, b );
             eventData.set("pt_x2_3", a );
             eventData.set("pt_y2_3", b );
             PTrackerCand->getPosH( a, b );
             eventData.set("pt_xtarg_3", a );
             eventData.set("pt_ytarg_3", b );
             eventData.set("pt_px_3", PTrackerCand->getPx() );
             eventData.set("pt_py_3", PTrackerCand->getPy() );
             eventData.set("pt_pz_3", PTrackerCand->getPz() );
             eventData.set("pt_theta0_3", PTrackerCand->getTheta0() );
             eventData.set("pt_phi0_3", PTrackerCand->getPhi0() );
             eventData.set("pt_match_3", PTrackerCand->getMatch() );
          } else if ( ptcounter == 4 ) {
             eventData.set("pt_p_4", PTrackerCand->getP() );
             eventData.set("pt_theta_4", PTrackerCand->getTheta() );
             eventData.set("pt_phi_4", PTrackerCand->getPhi() );
             eventData.set("pt_costh_4", PTrackerCand->getCosTheta() );
             PTrackerCand->getPos1( a, b );
             eventData.set("pt_x1_4", a );
             eventData.set("pt_y1_4", b );
             PTrackerCand->getPos2( a, b );
             eventData.set("pt_x2_4", a );
             eventData.set("pt_y2_4", b );
             PTrackerCand->getPosH( a, b );
             eventData.set("pt_xtarg_4", a );
             eventData.set("pt_ytarg_4", b );
             eventData.set("pt_px_4", PTrackerCand->getPx() );
             eventData.set("pt_py_4", PTrackerCand->getPy() );
             eventData.set("pt_pz_4", PTrackerCand->getPz() );
             eventData.set("pt_theta0_4", PTrackerCand->getTheta0() );
             eventData.set("pt_phi0_4", PTrackerCand->getPhi0() );
             eventData.set("pt_match_4", PTrackerCand->getMatch() );
          }
       }
    }
